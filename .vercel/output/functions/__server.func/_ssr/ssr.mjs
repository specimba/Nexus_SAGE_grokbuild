...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CW-U_qvN.mjs");
...
var manifest = { "feff7ded2d3a10a8052487e776965bf5e59cbfca2242aaf4520bdc461f5e0e8f": {
	functionName: "fetchEdition_createServerFn_handler",
	importer: () => import("./edition-4JlVkMe_.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Be9D2XTa.mjs").then((n) => n.t),
