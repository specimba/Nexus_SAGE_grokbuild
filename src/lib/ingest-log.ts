...
export type SourceId = "metr" | "wire" | "hf" | "tracker" | "x" | "mail" | "bookmarks";
...
export function snapshotIngest(at = new Date().toISOString()): SourceLog[] {
  return [
    ...
    { id: "wire", label: "Wire", live: true, ok: true, count: 0, ms: 0, at, note: "HuggingNews + eval desks · compile to fetch" },
